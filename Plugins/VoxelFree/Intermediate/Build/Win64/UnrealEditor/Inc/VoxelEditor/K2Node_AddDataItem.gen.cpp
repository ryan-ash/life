...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UK2Node_AddDataItem);
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DataItemConfig_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_AddDataItem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "K2Nodes/K2Node_AddDataItem.h" },
		{ "ModuleRelativePath", "Private/K2Nodes/K2Node_AddDataItem.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_AddDataItem_Statics::NewProp_DataItemConfig_MetaData[] = {
		{ "Category", "Config" },
		{ "ModuleRelativePath", "Private/K2Nodes/K2Node_AddDataItem.h" },
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UK2Node_AddDataItem_Statics::NewProp_DataItemConfig = { "DataItemConfig", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UK2Node_AddDataItem, DataItemConfig), Z_Construct_UClass_UVoxelGraphDataItemConfig_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UK2Node_AddDataItem_Statics::NewProp_DataItemConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_AddDataItem_Statics::NewProp_DataItemConfig_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_game_of_life_Plugins_VoxelFree_Source_VoxelEditor_Private_K2Nodes_K2Node_AddDataItem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_game_of_life_Plugins_VoxelFree_Source_VoxelEditor_Private_K2Nodes_K2Node_AddDataItem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_AddDataItem, UK2Node_AddDataItem::StaticClass, TEXT("UK2Node_AddDataItem"), &Z_Registration_Info_UClass_UK2Node_AddDataItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_AddDataItem), 3644627782U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_game_of_life_Plugins_VoxelFree_Source_VoxelEditor_Private_K2Nodes_K2Node_AddDataItem_h_1776896656(TEXT("/Script/VoxelEditor"),
		Z_CompiledInDeferFile_FID_game_of_life_Plugins_VoxelFree_Source_VoxelEditor_Private_K2Nodes_K2Node_AddDataItem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_game_of_life_Plugins_VoxelFree_Source_VoxelEditor_Private_K2Nodes_K2Node_AddDataItem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
